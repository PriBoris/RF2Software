...
#define MAX_RX_VALUE_LENGTH	(4096)
...
class Protocol
{
	private:
		...
		uint8_t rxValue[MAX_RX_VALUE_LENGTH];
		uint8_t rxTag;
		uint32_t rxID;
		uint16_t rxDataLen;
	...
	public:
		...
		static const uint8_t TAG_ReportIsokineticExcerciseSettings = 0x02;
		...
		static const uint8_t TAG_LoadIsokineticExcerciseSettings = 0x42;
